...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { image: @upload.image, mix_files: @upload.mix_files, mp4_file: @upload.mp4_file } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { image: @upload.image, mix_files: @upload.mix_files, mp4_file: @upload.mp4_file } }
